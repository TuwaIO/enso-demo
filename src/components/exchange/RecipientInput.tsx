      ...
      {!isExpanded ? (
        ...
        <div className="bg-[var(--tuwa-bg-secondary)] rounded-lg p-3 border border-[var(--tuwa-border-primary)] animate-in fade-in slide-in-from-top-1">
          <div className="flex justify-between items-center mb-2">
            ...
            <button
              onClick={toggleExpanded}
              className="text-xs text-[var(--tuwa-text-tertiary)] hover:text-[var(--tuwa-text-secondary)] transition-colors"
            >
              Cancel
            </button>
          </div>
          <div className="relative">
            <input
              ...
              placeholder="0x..."
              className="w-full pl-9 pr-3 py-2 text-sm bg-[var(--tuwa-bg-tertiary)] border border-[var(--tuwa-border-primary)] rounded-md text-[var(--tuwa-text-primary)] focus:outline-none focus:border-[var(--tuwa-button-gradient-from)] font-mono"
            />
            <WalletIcon className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--tuwa-text-tertiary)]" />
          </div>
          <p className="mt-1.5 text-[10px] text-[var(--tuwa-text-tertiary)]">
